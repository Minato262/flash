...
public abstract class NestedRuntimeException extends RuntimeException {
     ...
     *
     *    受检性异常，其实是一种相对落后的异常结构，如果处理不好，他会导致系统的突然崩溃，从语言
     * 的角度来讲 Java 的使用者，不应该在程序没有提示的情况下突然崩溃。所以在接触这类异常时，都
     * 需要经过有效处理或通过重试以恢复正常状态。但很多时候，去捕获这类异常其实是毫无益处的。所以，
     * 从编程的代码结构以及可读性的角度来讲，都是推荐使用非受检性异常的。
     *
